...
1.  **Создайте файл рабочего процесса GitHub Action**
    ...
    Создайте новый файл в репозитории по пути `.github/workflows/frenglish-translation.yml` и вставьте в него приведённый ниже код GitHub Action.
...
4\. **Установите зависимости SDK Frenglish**

Воспользуйтесь предпочитаемым менеджером пакетов для установки Frenglish:
